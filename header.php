	...
	<div id="page" class="hfeed">
		<header id="branding" role="banner">
			...
			<nav id="access" role="navigation">
				...
				<div class="skip-link"><a class="assistive-text" href="#secondary" title="<?php esc_attr_e( 'Skip to secondary content', 'twentyeleven' ); ?>"><?php _e( 'Skip to secondary content', 'themename' ); ?></a></div>
		...
		<div id="main" class="line gut">
			<?php if ( !is_page_template('left-sidebar-page.php')){?>
